...
class misasControlador extends misasModelo
{
    ...
    public function CtrInsertarMisa()
    {
        ...
        $consulta1 = mainModel::ejecutar_consulta_simple("SELECT act_fechacelebracion FROM datosactividad WHERE act_fechacelebracion = '$fechacelebracion'");
...
// Actualizar misa
    ...
    public function CtrlPaginadorMisas($pagina, $registros)
    {
        ...
        $datos = $conexion->query("SELECT SQL_CALC_FOUND_ROWS * FROM datosactividad as d INNER JOIN tipoactividad as t ON d.id_tipoActividad=t.id_tipoActividad where t.tip_descripcion LIKE '%misa%' ORDER by d.id_datosActividad ASC LIMIT $inicio, $registros");
