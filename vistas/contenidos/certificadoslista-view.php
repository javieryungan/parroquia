...
<div class="container-fluid">
	<ul class="breadcrumb breadcrumb-tabs">
		<li>
			<a href="<?php echo SERVERURL; ?>certificados/" class="btn btn-info">
				<i class="zmdi zmdi-plus"></i> &nbsp; NUEVO CERTIFICADO
			</a>
		</li>
		<li>
				...
				<table class="table table-hover text-center">
					<thead>
						<tr>
							...
							<th class="text-center">NOMBRES PERSONA</th>
							<th class="text-center">TIPO</th>
							<th class="text-center">DESCARGAR</th>
							<th class="text-center">ID APORTE</th>
