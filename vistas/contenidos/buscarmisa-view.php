			...
			<?php
if (!isset($_SESSION['busqueda_misa']) && empty($_SESSION['busqueda_misa'])) {

    ?>

			<div class="container-fluid">
				<form class="form-neon" action="">
					<input type="hidden" name="modulo" value="misas">
					<div class="container-fluid">
						<div class="row justify-content-md-center">
							<div class="col-12 col-md-6">
								<div class="form-group">
									<label for="inputSearch" class="bmd-label-floating">¿Qué misa estas buscando?</label>
