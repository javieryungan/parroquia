...
$carita = new caritasControlador();
$carita = $carita->CtrlEditarCarita();
?>
          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-6">
              <div class="form-group label-floating">
                ...
                <textarea name="descripcionup-carita" class="form-control" rows="2" maxlength="100" value="<?php echo $carita['car_descripcion'] ?>"></textarea>
              </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-6">
              <div class="form-group label-floating">
                ...
                <input class="form-control" type="hidden" name="idup-carita" maxlength="50" value="<?php echo mainModel::encryption($carita['id_carita']) ?>">

                <input pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,30}" class="form-control" type="text" name="tipobeneficioup-carita" required="" maxlength="30" value="<?php echo $carita['car_tipobeneficio'] ?>">
              </div>
            </div>
