  ...
  <div class="container-fluid">
    <div class="page-header">
      <h1 class="text-titles"><i class="zmdi zmdi-account zmdi-hc-fw"></i> Enviar datos<small>NECESARIOS</small></h1>
    </div>
  ...
  <div class="container-fluid">
    <div class="panel panel-info">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="zmdi zmdi-plus"></i> &nbsp; Envio de datos</h3>
      </div>
        ...
        <form>
          <fieldset>
            ...
            <div class="card-header">
              <h3 class="card-title">Enviar datos necesarios</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <select class="form-control">
                  ...
                  <div class="col-xs-12">
                  <div class="form-group">
                    <span class="control-label">Seleccionar Comprobante de pago</span>
