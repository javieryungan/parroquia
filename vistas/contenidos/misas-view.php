       ...
       <fieldset>
          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-6">
              <div class="form-group label-floating">
                ...
                <input pattern="[0-9+]{1,15}" class="form-control" type="datetime-local" name="fechacelebracion" maxlength="15" required="">
              </div>
            </div>
        ...
        <div class="col-xs-12 col-sm-6">
                <div class="form-group label-floating">
                  ...
                  <select class="form-control" name="tipoactividad" id="">
