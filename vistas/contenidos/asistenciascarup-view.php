...
$editarasistenciacar = $asistenciacarita->CtrlEditarAsistenciacarita();
?>
          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-6">
              <div class="form-group label-floating">
                ...
                <input type="hidden" name="idup-asistenciacar" value="<?php echo mainModel::encryption($editarasistenciacar['id_usuario']) ?>">

                <select class="form-control" name="beneficiarioup-asistenciacar" id="">
    ...
    ?><option value="<?php echo $value['id_usuario'] ?>"> <?php echo $value['nombres_apellidos'] ?> </option>
          ...
          <div class="col-xs-12 col-sm-6">
            <div class="form-group label-floating">
              ...
              <select class="form-control" name="caritaup-asistenciacar" id="">
