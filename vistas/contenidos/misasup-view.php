                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <div class="form-group label-floating">
                                    ...
                                    <select class="form-control" name="tipoactividadup-misa" id="selectpaisesid"  onchange="selectpaises('<?php echo SERVERURL ?>ajax/misasAjax.php')" required>
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <div class="form-group label-floating">
                                    <label class="control-label"><br>Fecha programada *</label>

                                    <input type="hidden" name="idup-misa" value="<?php echo mainModel::encryption($editarmisa['id_datosActividad']) ?>">

                                    <input pattern="[0-9+]{1,15}" class="form-control" type="date" name="fechacelebracionup-misa" value="<?php echo $editarmisa['act_fechacelebracion'] ?>" required="">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <div class="form-group label-floating">
                                    ...
                                    <select class="form-control" name="horario" id="selectestado" required>
                                        <option value="<?php echo $editarmisa['id_horario'] ?>"> <?php echo $editarmisa['hora_inicio'] ?> - <?php echo $editarmisa['hora_fin'] ?> </option>
                                    </select>
                                </div>
                            </div>
