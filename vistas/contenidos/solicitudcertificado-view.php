  ...
  <div class="container-fluid">
    <div class="page-header">
      <h1 class="text-titles"><i class="zmdi zmdi-account zmdi-hc-fw"></i> Solicitud <small>CERTIFICADO</small></h1>
    </div>
  ...
  <div class="container-fluid">
    <div class="panel panel-info">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="zmdi zmdi-plus"></i> &nbsp; CERTIFICADO</h3>
      </div>
        ...
        <form>
          <fieldset>
            ...
            <div class="card-body">
             ...
             <div class="form-group">
              <label>Seleccione Certificado</label>
