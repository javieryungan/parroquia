<div class="container-fluid">
	<div class="page-header">
		<h1 class="text-titles"><i class="zmdi zmdi-account zmdi-hc-fw"></i> LISTA<small> BAUTISMO</small></h1>
	</div>
	...
	<ul class="breadcrumb breadcrumb-tabs">
		...
		<li>
			<a href="<?php echo SERVERURL; ?>bautismoslista/" class="btn btn-success">
				<i class="zmdi zmdi-format-list-bulleted"></i> &nbsp; LISTA DE BAUTIMOS
			</a>
		</li>
		<li>
...
<div class="container-fluid">
	<div class="panel panel-success">
		<div class="panel-heading">
			<h3 class="panel-title"><i class="zmdi zmdi-format-list-bulleted"></i> &nbsp; LISTA DE BAUTISMOS</h3>
		</div>
				...
				<table class="table table-hover text-center">
					<thead>
						<tr>
							...
							<th class="text-center">DIRECCIÓN PADRE </th>
							<th class="text-center">NOMBRES MADRE </th>
							<th class="text-center">APELLIDOS MADRE </th>
							<th class="text-center">TELÉFONO MADRE </th>
							<th class="text-center">DIRECCIÓN MADRE </th>
							<th class="text-center">NOMBRES PADRINO</th>
							<th class="text-center">APELLIDOS PADRINO</th>
							<th class="text-center">ESTADO CIVIL PADRINO </th>
							<th class="text-center">NOMBRES MADRINA</th>
							<th class="text-center">APELLIDOS MADRINA</th>
							<th class="text-center">ESTADO CIVIL MADRINA</th>
							<th class="text-center">FECHA DE CELEBRACIÓN</th>
							<th class="text-center">ACTA DE NACIMIENTO</th>
							<th class="text-center">CERTIFICADO DE MATRIMONIO PADRINO </th>
							<th class="text-center">CERTIFICADO DE MATRIMONIO MADRINA  </th>
