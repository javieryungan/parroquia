...
<!-- Panel listado de asistencia carita -->

<div class="container-fluid">
      <div class="panel panel-success">
        <div class="panel-heading">
          <h3 class="panel-title"><i class="zmdi zmdi-format-list-bulleted"></i> &nbsp; LISTA DE ASISTENCIAS DE CÁRITAS</h3>
        </div>
        <div class="panel-body">
          <div class="table-responsive">
            <?php require_once './controladores/asistenciacarita.controlador.php';
$insasistenciacar = new asistenciacaritaControlador();
$pagina           = explode("/", $_GET["views"]);
echo $insasistenciacar->CtrlPaginadorAsistenciacaritas($pagina[1], 3);
?>
