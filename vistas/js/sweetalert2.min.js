    ...
    var s = function (e, t) {
        ...
        _ = function (e) {
            ...
            if (((a.innerHTML = e.title.split("\n").join("<br>")), e.text || e.html)) {
                if ("object" === D(e.html))
                    if (((l.innerHTML = ""), 0 in e.html)) for (var d = 0; d in e.html; d++) l.appendChild(e.html[d].cloneNode(!0));
            ...
            e.progressSteps.length
                ? (L(b),
                  M(b),
                  S >= e.progressSteps.length && console.warn("SweetAlert2: Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"),
            ...
            e.imageUrl
                ? (O.setAttribute("src", e.imageUrl),
                  L(O),
                  e.imageWidth ? O.setAttribute("width", e.imageWidth) : O.removeAttribute("width"),
                  e.imageHeight ? O.setAttribute("height", e.imageHeight) : O.removeAttribute("height"),
                  (O.className = n.image),
                  e.imageClass && A(O, e.imageClass))
                : q(O),
                e.showCancelButton ? (c.style.display = "inline-block") : q(c),
                e.showConfirmButton ? V(s, "display") : q(s);
            var N = y();
            e.showConfirmButton || e.showCancelButton ? L(N) : q(N),
                (s.innerHTML = e.confirmButtonText),
                (c.innerHTML = e.cancelButtonText),
                e.buttonsStyling && ((s.style.backgroundColor = e.confirmButtonColor), (c.style.backgroundColor = e.cancelButtonColor)),
                (s.className = n.confirm),
                A(s, e.confirmButtonClass),
                (c.className = n.cancel),
                A(c, e.cancelButtonClass),
                e.buttonsStyling
                    ? (A(s, n.styled), A(c, n.styled))
                    : (B(s, n.styled), B(c, n.styled), (s.style.backgroundColor = s.style.borderLeftColor = s.style.borderRightColor = ""), (c.style.backgroundColor = c.style.borderLeftColor = c.style.borderRightColor = "")),
                e.animation === !0 ? B(t, n.noanimation) : A(t, n.noanimation);
        },
        z = function (e, t) {
            var o = p();
            e ? (A(o, n.show), A(a, n.fade), B(o, n.hide)) : B(o, n.fade),
                L(o),
        ...
        $ = function () {
            ...
            switch (D(t[0])) {
                ...
                case "object":
                    W(r, t[0]),
                        (r.extraParams = t[0].extraParams),
                        "email" === r.input &&
                            null === r.inputValidator &&
                            (r.inputValidator = function (e) {
            ...
            return new Promise(function (e, t) {
                ...
                for (
                    var u = function (t) {
                            r.showLoaderOnConfirm && F.showLoading(),
                                r.preConfirm
                                    ? r.preConfirm(t, r.extraParams).then(
                                          function (n) {
                        ...
                        d = function (e) {
                            ...
                            switch (n.type) {
                                case "mouseover":
                                case "mouseup":
                                    r.buttonsStyling && (c ? (i.style.backgroundColor = s(r.confirmButtonColor, -0.1)) : d && (a.style.backgroundColor = s(r.cancelButtonColor, -0.1)));
                                    break;
                                case "mouseout":
                                    r.buttonsStyling && (c ? (i.style.backgroundColor = r.confirmButtonColor) : d && (a.style.backgroundColor = r.cancelButtonColor));
                                    break;
                                case "mousedown":
                                    r.buttonsStyling && (c ? (i.style.backgroundColor = s(r.confirmButtonColor, -0.2)) : d && (a.style.backgroundColor = s(r.cancelButtonColor, -0.2)));
                                    break;
                                case "click":
                                    c && F.isVisible()
                                        ? r.input
                                            ? !(function () {
                                                  ...
                                                  r.inputValidator
                                                      ? (F.disableInput(),
                                                        r.inputValidator(e, r.extraParams).then(
                                                            function () {
                                                                F.enableInput(), u(e);
                                                            },
                                                            function (e) {
                                            ...
                                            : u(!0)
                                        : d && F.isVisible() && (F.closeModal(r.onClose), t("cancel"));
                            }
                        },
                        f = i.querySelectorAll("button"),
                        m = 0;
                    m < f.length;
                    m++
                )
                    (f[m].onclick = d), (f[m].onmouseover = d), (f[m].onmouseout = d), (f[m].onmousedown = d);
                (k().onclick = function () {
                ...
                var x = function (e, t) {
                    ...
                    M = function (e) {
                        ...
                        if ([9, 13, 32, 27].indexOf(o) !== -1) {
                            ...
                            9 === o
                                ? (n.shiftKey ? x(l, -1) : x(l, 1), n.stopPropagation(), n.preventDefault())
                                : 13 === o || 32 === o
                                ? l === -1 && (r.focusCancel ? H(h, n) : H(v, n))
                                : 27 === o && r.allowEscapeKey === !0 && (F.closeModal(r.onClose), t("esc"));
                        }
                    };
                (c.previousWindowKeyDown = window.onkeydown),
                    (window.onkeydown = M),
                    r.buttonsStyling && ((v.style.borderLeftColor = r.confirmButtonColor), (v.style.borderRightColor = r.confirmButtonColor)),
                    (F.showLoading = F.enableLoading = function () {
                    ...
                    (F.showValidationError = function (e) {
                        var t = b();
                        (t.innerHTML = e), L(t);
                        var r = o();
                ...
                !(function () {
                    ...
                    ("select" !== r.input && "radio" !== r.input) ||
                        (r.inputOptions instanceof Promise
                            ? (F.showLoading(),
                              r.inputOptions.then(function (e) {
                                  F.hideLoading(), Y(e);
                              }))
                            : "object" === D(r.inputOptions)
                            ? Y(r.inputOptions)
                            : console.error("SweetAlert2: Unexpected type of inputOptions! Expected object or Promise, got " + D(r.inputOptions))),
                    z(r.animation, r.onOpen),
                    x(-1, 1),
                    (a.scrollTop = 0),
                    "undefined" == typeof MutationObserver || R || ((R = new MutationObserver(F.recalculateHeight)), R.observe(i, { childList: !0, characterData: !0, subtree: !0 }));
            });
        },
        F = function e() {
