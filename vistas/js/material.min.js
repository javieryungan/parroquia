!(function (a) {
    function b(a) {
        return "undefined" == typeof a.which
            ...
            ? !a.ctrlKey && !a.metaKey && !a.altKey && 8 != a.which && 9 != a.which && 13 != a.which && 16 != a.which && 17 != a.which && 20 != a.which && 27 != a.which
            : !1;
    }
    function c(b) {
        var c = a(b);
    ...
    function e(b) {
        var e = !1;
        (b.is(a.material.options.checkboxElements) || b.is(a.material.options.radioElements)) && (e = !0),
            ...
            input: function (b) {
                a(b ? b : this.options.inputElements)
                    ...
                    .each(function () {
                        ...
                        0 !== c.length || "hidden" === b.attr("type") || b.attr("hidden") || (b.wrap("<div class='form-group'></div>"), (c = b.closest(".form-group"))),
                            b.attr("data-hint") && (b.after("<p class='help-block'>" + b.attr("data-hint") + "</p>"), b.removeAttr("data-hint"));
